  ...
  return (
    <div id="about" className="flex flex-col min-h-screen">
      ...
      <div className="bg-white flex-grow relative">
        <Card className="max-w-7xl bg-[#F8F8F8] mx-auto md:p-15  pl-72 p-2 shadow-xl border-0 absolute left-4 right-4 -top-20 md:-top-24">
          ...
          <div className="container  max-sm:w-fit mx-auto md:px-4 md:pt-24  pb-12 ">
            <div className="grid grid-cols-1   md:grid-cols-3 pl-[28px] max-sm:pl-0 md:pl-8 md:gap-16 gap-12 max-w-7xl mx-auto">
              {/* Feature 1 */}

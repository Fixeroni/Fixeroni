...
function RegisterClient() {
  ...
  return (
    <div>
      <form className="max-sm:px-2 justify-center place-items-center">
        <RegisterInpu
        ...
        <button
          className="font-semibold text-white bg-[#0F9067] shadow-sm mb-6 transition duration-300 p-2 hover:cursor-pointer h-[44px] rounded-[20px] max-sm:w-[290px]  w-[356px]"
          type="submit"
        >
          Register
        </button>

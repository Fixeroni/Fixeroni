...
function RouteComponent() {
  ...
  return (
   ...
   <div className=' p-[10px] flex items-center justify-between'>
      <button onClick={toggleModal} className='shadow-[2px_2px_5px_rgba(0,0,0,0.05)] p-[15px] pl-[17px] pr-[17px] rounded-tr-[20px] rounded-[26px] bg-[#fff] outline-none flex items-center justify-center'>
        All Kinds 
        <i className="fa-solid fa-chevron-down text-sm ml-[10px]"></i>
      </button>
      <button onClick={toggleDistanceModal} className='shadow-[2px_2px_5px_rgba(0,0,0,0.05)] p-[15px] pl-[17px] pr-[17px] rounded-tr-[20px] rounded-[26px] bg-[#fff] outline-none flex items-center justify-center'>
        All Distance
        <i className="fa-solid fa-chevron-down text-sm ml-[15px]"></i>
      </button>
      <button onClick={toggleStatus} className='shadow-[2px_2px_5px_rgba(0,0,0,0.05)] p-[15px] pl-[17px] pr-[17px] rounded-tr-[20px] rounded-[26px] bg-[#fff] outline-none flex items-center justify-center'>
        All Status 
        <i className="fa-solid fa-chevron-down text-sm ml-[10px]"></i>
      </button>
      <button onClick={toggleCity} className='shadow-[2px_2px_5px_rgba(0,0,0,0.05)] p-[15px] pl-[17px] pr-[17px] rounded-tr-[20px] rounded-[26px] bg-[#fff] outline-none flex items-center justify-center'>
        All Cities 
        <i className="fa-solid fa-chevron-down text-sm ml-[10px]"></i>
      </button>
    </div>
        ...
        {city && (
          <div className='modal-contents fixed top-[170px] left-[800px] rounded-[25px]  flex flex-col gap-[2px] bg-[white] pb-[20px] z-50'>
            ...
            <div className="container grid grid-cols-5 grid-rows-3 gap-2 p-[20px]">
              ...
              <div className="col-span-1 flex items-center text-black ">500</div>
              <div className="flex items-center col-span-1 "><input type='checkbox'/></div>
              <div className="flex items-center col-span-3 text-black ">Lagos</div>
              <div className="col-span-1 flex items-center text-black ">100</div>
              <div className="flex items-center col-span-1 "><input type='checkbox'/></div>
              <div className="flex items-center col-span-3 text-black ">Enugu</div>
              <div className="col-span-1 flex items-center text-black ">100</div>
              <div className="flex items-center col-span-1 "><input type='checkbox'/></div>
              <div className="flex items-center col-span-3 text-black ">Port Harcourt</div>
              <div className="col-span-1 flex items-center text-black ">100</div>
              <div className="flex items-center col-span-1 "><input type='checkbox'/></div>
              <div className="flex items-center col-span-3 text-black ">Owerri</div>
              <div className="col-span-1 flex items-center text-black ">100</div>
  ...
  <div className="col-span-1 flex items-center  text-black ">100</div>
        ...
        <div className=' p-[10px] flex items-center justify-between'>
          ...
          {modal && (
            <div className='rounded-[25px] fixed top-[180px] w-[17%] bg-[#fff] pb-[20px] z-70 h-[400px] overflow-y-auto'>
              <div className='w-[16%] pl-[15px] fixed bg-[#fff] z-100 pr-[15px] flex justify-between items-center pt-[20px]'>
                <p className='text-[20px] text-poppins ml-[17px]'>Kinds</p>
                <button>
                  <i onClick={toggleModal} className="fa-solid fa-times text-[20px] mr-[17px]"></i>
                </button>
              </div>
              <div className="modal-content pl-[16px] pt-[20px]">
              <div  className="container w-[100%]  grid grid-cols-5  gap-2 p-[13px]  mt-[50px]">
  <div className=" flex items-center col-span-1 "><input  type='checkbox'/></div>
  ...
  <button type='submit' className='w-[100%] p-[5px] rounded-[15px] bg-[black] text-[18px] text-[white]'>Apply</button>

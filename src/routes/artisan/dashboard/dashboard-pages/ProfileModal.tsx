      ...
      <div className="w-[406px]   h-fit bg-[#FFFFFF] rounded-[20px] shawdow---feature mt-4 mb-3">
        ...
        <section>
          ...
          <div className="flex flex-col justify-center items-center ">
            <h2 className="text-[#1E1E1E] font-medium text-[24px] pt-2">
              Ben Hooder
            </h2>
        ...
        <section className="px-6 mt-4 overflow-hidden">
          <div className="bg-[url('/images/branding/availbaldash.png')] bg-cover bg-no-repeat  profile----availablebal-shawdow rounded-[6.98964px] w-full h-full ">
            <div className="py-6 ml-6 flex flex-col">
              <h3 className="text-[#FFFFFF] opacity-[0.9] font-light text-[18px] ">
                Available Balance
              </h3>
              <h3 className="text-[#FFFFFF] text-[35px] font-normal tracking-[2px]">
                <span className="line-through">N</span>500.00
              </h3>
            </div>
            ...
            <div className="px-4 flex items-center justify-between pb-5">
              <ProfileButton
                name={"Top Up"}
                icon={"/images/icons/top-up--icon.png"}
              />
              <ProfileButton
                name={"Withdraw"}
                icon={"/images/icons/withdraw--icon.png"}
              />
            </div>
          </div>
        </section>
        ...
        <ProfileDetails
          ...
          date={"Feb 25, 2025"}
          amount={"+$50.00"}
          icon={"/images/icons/top-up---arrow.png"}
        ...
        <ProfileDetails
          ...
          date={"Feb 24, 2025"}
          amount={"-$120.00"}
          icon={"/images/icons/profil-up--arrow-icon.png"}
        ...
        <section className="pb-9">
          <div className="border-t-[#EDEDED] border mt-10 h-[5rem] border-b-0 border-l-0 border-r-0  px-7 ">
            <div className="flex items-center gap-5 mt-6">
              <div className="">
                <img
                  src="/images/icons/refer-earn--icon.png"
                  alt=""
                  className="w-full"
                />
              </div>
              <div>
                <h3 className="text-[#1E1E1E] text-[24px] font-normal ">
                  Refer & Earn{" "}
                </h3>
                <p className="text-[#6B7280] text-[14px] font-normal pt-2">
